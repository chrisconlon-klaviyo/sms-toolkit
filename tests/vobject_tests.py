...
from sms_toolkit.vobject.icalendar import MultiDateBehavior, PeriodBehavior, \
    RecurringComponent, utc
from sms_toolkit.vobject.icalendar import parseDtstart, stringToTextValues, \
...
class TestBehaviors(unittest.TestCase):
    ...
    def test_general_behavior(self):
        ...
        self.assertEqual(
            str(behavior),
            "<class 'sms_toolkit.vobject.icalendar.VCalendar2_0'>"
        )
